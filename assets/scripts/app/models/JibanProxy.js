...
var i = require("../utils/Utils"),
    ...
    a = (function() {
        ...
        t.prototype.updateRed = function() {
            ...
            r.default.change("jibanwife", e);
            r.default.change("jibanhero", o);
        };
        t.prototype.onHeroJB = function(t) {
        ...
        t.prototype.onWifeJB = function(t) {
        ...
        t.prototype.onHeroSW = function(t) {
        ...
        t.prototype.onSelectGroup = function(t) {
            this.selectGroup = t.id;
            facade.send(this.UPDATE_SELECT_GROUP);
        };
        t.prototype.onJbItem = function(t) {
            this.jbItem = t;
            facade.send(this.UPDATE_JI_BAN_ITEM);
        };
        t.prototype.onWishingCount = function(t) {
            this.wishing = t;
            facade.send(this.UPDATE_WISHING_COUNT);
        };
        t.prototype.onShowJibanItem = function(t) {
            i.utils.openPrefabView("jiban/JibanItemShow", null, {
                list: t
            });
        };
        t.prototype.alertChange = function(t, e, o) {
            if (null != e && null != t) {
        ...
        t.prototype.getHeroNextJb = function(t, e) {
            for (
        ...
        t.prototype.getWifeNextJb = function(t) {
            for (
        ...
        t.prototype.setDelayShow = function(t) {
            this.delayShow = t;
        ...
        t.prototype.getJibanLv = function(t, e) {
        ...
        t.prototype.isJibanUp = function(t, e, o) {
        ...
        t.prototype.onBelief = function(t) {
        ...
        t.prototype.onJibanList = function(t) {
            this.jibanList = t;
            facade.send(this.UPDATE_JIBAN);
            this.updateRed();
        };
        t.prototype.getJibanType = function(t, e) {
            var o = [],
        ...
        t.prototype.getJibanData = function(t, e) {
        ...
        t.prototype.isOverStory = function(t) {
        ...
        t.prototype.saveHeroStory = function(t) {
            var e = new proto_cs.scpoint.recored();
            e.id = t;
            JsonHttp.send(e);
        };
        t.prototype.sendGetAward = function(t, e) {
            void 0 === e && (e = !0);
        ...
        t.prototype.isDuplicat = function(t) {
        ...
        t.prototype.sendGetJYAward = function(t) {
        ...
        t.prototype.sendGetZWAward = function(t) {
        ...
        t.prototype.sendWishing = function(t, e) {
        ...
        t.prototype.sendWishInfo = function() {
            var t = new proto_cs.user.wishInfo();
            JsonHttp.send(t);
        };
        t.prototype.getJibanFirst = function(t) {
            for (
                var e = [],
        ...
        t.prototype.getJibanIsOpen = function(t) {
            if (null == t) return !1;
            switch (t.unlocktype) {
                case 1:
        ...
        t.prototype.getJbItemCount = function(t, e, o) {
            void 0 === o && (o = 1);
            var i = 0;
            if (0 == e)
                for (
        ...
        t.prototype.getJbItemList = function(t, e) {
            var o = this;
            void 0 === e && (e = 1);
            var i = [],
        ...
        t.prototype.getJbItemAddPro = function(t, e) {
            var o = {
                    pro: 0,
                    value: 0
                },
        ...
        t.prototype.getJbItemLvData = function(t, e) {
        ...
        t.prototype.getJbItemLv = function(t, e) {
            var o = this.getJbItemData(t);
            if (o)
                for (var i = 0; i < o.jibans.length; i++)
