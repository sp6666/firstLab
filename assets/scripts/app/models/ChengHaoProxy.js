...
var i = require("../utils/Utils"),
    ...
    r = (function() {
        ...
        t.prototype.onChengHaoInfo = function(t) {
            if (null == this.chInfo) {
        ...
        t.prototype.getChengHao = function(t) {
        ...
        t.prototype.sortCh = function(t, e) {
            var o = t.getT > 0 ? 0 : 1,
                i = e.getT > 0 ? 0 : 1;
            return o != i ? o - i : t.chid - e.chid;
        };
        t.prototype.getLeftCd = function(t) {
            return Math.max(0, t - i.timeUtil.second);
        };
        t.prototype.isShow = function(t, e) {
