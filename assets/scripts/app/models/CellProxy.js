...
var i = require("../utils/Utils"),
    ...
    a = (function() {
        ...
        t.prototype.updateCellRed = function() {
            if (
        ...
        t.prototype.onLaoFang = function(t) {
            this.laoFangData = t;
            this.updateCellRed();
            facade.send(this.LAO_FANG_DATA_UPDATE);
        };
        t.prototype.onMingWang = function(t) {
            this.mingWangData = t;
            this.updateCellRed();
        ...
        t.prototype.onPets = function(t) {
            this.pets = t;
            facade.send(this.LAO_FANG_PET_LIST);
        };
        t.prototype.sendBianDa = function(t, e) {
        ...
        t.prototype.getTqStr = function(t) {
            if (null == t) return "";
