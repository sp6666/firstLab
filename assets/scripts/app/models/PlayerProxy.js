...
var i = require("../utils/Utils"),
    ...
    s = (function () {
        function t() {
            ...
            this._mainCityMode = 'default';
            this.alert5min = false;
            this.clothePartType = 0;    //关卡换装类型
            this.clothePartCount = 0;   //关卡换装序号

            this.startTopViewMsg = 0;  //初始需要拉取的消息计数
            this.TOP_VIEW_MSG = "TOP_VIEW_MSG"; //拉到消息以后回调
        }
        t.prototype.ctor = function () {
            ...
            JsonHttp.subscribe(proto_sc.userhead.heads, this.onHeads, this);
            JsonHttp.subscribe(proto_sc.userhead.headtime, this.onHeadTime, this);
            JsonHttp.subscribe(
        ...
        t.prototype.onSuitLv = function (t) {
            this.suitlv = t;
            facade.send(this.PLAYER_CLOTH_SUIT_LV);
        };
        t.prototype.onClotheScore = function (t) {
            this.clotheScore = null == t.score ? 0 : t.score;
            facade.send(this.PLAYER_CLOTHE_SCORE);
        };
        t.prototype.onUserClothe = function (t) {
            this.userClothe = t;
            facade.send(this.PLAYER_SHOW_CHANGE_UPDATE);
        };
        t.prototype.onBlankTime = function (t) {
            this.blankTime = t;
        };
        t.prototype.onBlanks = function (t) {
            this.blanks = t;
        };
        t.prototype.onHeadTime = function (t) {
            this.headtime = t;
        };
        t.prototype.onHeads = function (t) {
            this.heads = t;
        };
        t.prototype.onHeadAvatar = function (t) {
            this.headavatar = t;
            facade.send(this.PLAYER_UPDATE_HEAD);
        };
        t.prototype.onLimitTime = function (t) {
            this.limitTime = t;
        ...
        t.prototype.updateRoleLvupRed = function () {
            ...
            if (null != t) {
                ...
                if (e) {
                    ...
                    a.default.change("rolelvup", e);
                } else a.default.change("rolelvup", e);
            }
        };

        t.prototype.checkMainCityMode = function (mode) {
            this._mainCityMode = mode;

            if (i.stringUtil.isBlank(this._mainCityMode)) {
                var d = new Date();
                //2020/1/1
                d.setFullYear(2020, 0, 1);
                d.setHours(0);
                d.setMinutes(0);
                var refreshTime = d.getTime() / 1000;
                if (this.userData.regtime > refreshTime) {
                    //新用户
                    this._mainCityMode = 'default';
                } else {
                    this._mainCityMode = 'snow';
                }
        ...
        t.prototype.onGuideData = function (t) {
            this.guide = t;
            facade.send(this.PLAYER_GUIDE_UPDATE);
        };
        t.prototype.onFuserData = function (t) {
            this.fuser = t;
            facade.send(this.PLAYER_FUSER_UPDATE);
        };
        t.prototype.onEpData = function (t) {
            this.userEp = t;
            facade.send(this.PLAYER_EP_UPDATE);
        };
        t.prototype.onPaoMa = function (t) {
        ...
        t.prototype.onHeroShow = function (t) {
            if (t.idm) {
                this.heroShow = t.idm;
            } else {
                if (t.id)
            ...
            //this.heroShow = 0 == t.idm ? 1 : t.idm;
            //add by cjf
            this.zwHeroShow = t.idf ? t.idf : 202;
            facade.send(this.PLAYER_HERO_SHOW);
        };
        t.prototype.onClothes = function (t) {
            this.clothes = t;
        ...
        t.prototype.onUpdateGuangGao = function (t) {
            this.guanggao = t;
            facade.send(this.GUANG_GAO_UPDATE);
        };
        t.prototype.onAddicted = function(t) {
            cc.log("========= onAddicted " + t.end_time);
            if(t == null) return;
            if(i.timeUtil.second >= t.end_time) {
                i.utils.showSingeConfirm(i18n.t("ADDICTED_PT_LIMIT"), function () {
                    n.loginProxy.loginOut();
                })
            }else if(!this.alert5min && i.timeUtil.second + 300 >= t.end_time) {
                this.alert5min = true;
                i.utils.showSingeConfirm(i18n.t("ADDICTED_TIME_LEFT"));
            }
        };
        t.prototype.addStoryId = function (t) {
            if (-1 == this.storyIds.indexOf(t)) {
                this.storyIds.push(t);
                facade.send("SHOW_STORY");
            }
        };
        t.prototype.sendAdok = function (t) {
            var e = new proto_cs.user.adok();
            e.label = t;
            JsonHttp.send(e);
        };
        t.prototype.sendUserUp = function () {
            var t = new proto_cs.user.shengguan();
            JsonHttp.send(t, function () {
                i.utils.openPrefabView("user/UserUpEffect");
            });
        };
        t.prototype.getPartId = function (t, e) {
        ...
        t.prototype.sendHeroShow = function (t) {
            var e = new proto_cs.user.serHeroShow();
            e.id = t;
            JsonHttp.send(e);
        };
        t.prototype.getStoryData = function (t) {
                        ...
                        (e = localcache.getItem(localdb.table_story5, t)) ?
                            ...
                            (e = localcache.getItem(localdb.table_story6, t)) ?
                                ...
                                (e = localcache.getItem(localdb.table_storyzw, t)) ?
                                    e :
                                    (e = localcache.getItem(localdb.table_confidante_bf_story, t)) ||
                                    null)
            );
        };
        t.prototype.getStorySelect = function (t) {
            var e;
            if (
                null ==
        ...
        t.prototype.stroyIsCanSelect = function (t) {
        ...
        t.prototype.getEmailData = function (t) {
            return localcache.getItem(localdb.table_email, t);
        };
        t.prototype.getEmailGroup = function (t, e) {
            return localcache.getGroup(localdb.table_email, e, t);
        };
        t.prototype.getReplaceName = function (t) {
        ...
        t.prototype.initOffice = function () {
            if (0 == this._maxLv) {
        ...
        t.prototype.getAllOffice = function () {
            this.initOffice();
            return this._allOffice;
        };
        t.prototype.getOfficeDes = function (t) {
            if (null == t) return "";
            var e = "",
                o = 1;
            if (0 != t.heroid) {
        ...
        t.prototype.getKindIdName = function (t, e) {
            switch (t) {
                case 3:
                ...
                case 98:
                    var a = localcache.getItem(localdb.table_userhead, e);
                    return a ? a.name : "";
                case 999:
        ...
        t.prototype.getRwdString = function (t) {
        ...
        t.prototype.officeLvIsOver = function (t) {
            if (null == t) return !1;
            var e = t.para + "";
            switch (t.condition) {
                case 1:
        ...
        t.prototype.officeOpen = function (t) {
            switch (t.condition) {
                case 1:
        ...
        t.prototype.getOfficeLvError = function (t) {
            if (null == t) return "";
            var e = t.para + "";
            switch (t.condition) {
                case 1:
        ...
        t.prototype.isUnlockCloth = function (t) {
            ...
            if (this.clothes && -1 != this.clothes.indexOf(t)) {
                if (0 != e.limit)
                    for (
                        var o = 0; this.limitTime && o < this.limitTime.length; o++
                    )
                        if (
        ...
        t.prototype.getSuitCount = function (t) {
        ...
        t.prototype.getRemainClotheTime = function (t) {
        ...
        t.prototype.sendCloth = function (t, e, o, n, l, r, a) {
            void 0 === a && (a = !0);
        ...
        t.prototype.sendUnlockCloth = function (t) {
        ...
        t.prototype.sendGetOther = function (t, e) {
            void 0 === e && (e = 0);
        ...
        t.prototype.sendHeadBlank = function (t, e) {
        ...
        t.prototype.sendResetName = function (t, e) {
            void 0 === e && (e = 1);
        ...
        t.prototype.sendResetJob = function (t) {
        ...
        t.prototype.sendAddition = function () {
            JsonHttp.send(new proto_sc.user.addition());
        };
        t.prototype.isHaveBlank = function (t) {
            return (
                null != this.blanks &&
                !(!this.blanks || -1 == this.blanks.indexOf(t))
            );
        };
        t.prototype.isHaveHead = function (t) {
            return (
                null != this.heads &&
                !(!this.heads || -1 == this.heads.indexOf(t))
            );
        };
        t.prototype.onQifuDat = function (t) {
            this.qifuData = t;
        ...
        t.prototype.onAddition = function (t) {
            this.addition = t;
            facade.send(this.PLAYER_ADDITION_UPDATE);
        };
        t.prototype.sendQifu = function (t) {
            var e = new proto_cs.user.qifu();
            e.jyid = t;
            JsonHttp.send(e);
        };
        t.prototype.getVipValue = function (t) {
            var e = localcache.getItem(
                localdb.table_vip,
