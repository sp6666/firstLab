...
var i = require("../utils/Utils"),
    ...
    r = (function () {
        ...
        t.prototype.onWifeList = function (t) {
            null == this.wifeList ?
                (this.wifeList = t) :
            ...
            l.default.change("wifeSkill", this.hasRed());
        ...
        t.prototype.hasSkillUp = function (t) {
        ...
        t.prototype.onWifeBase = function (t) {
            this.base = t;
        };
        t.prototype.onFirstBorn = function (t) {
            facade.send(this.WIFE_FIRST_BORN);
        };
        t.prototype.onJingLi = function (t) {
            this.jingliData = t;
            l.default.change("wife_jingli", t.num > 0);
            facade.send(this.WIFE_JING_LI);
        };
        t.prototype.onJiaQi = function (t) {
            this.jiaqiData = t;
            l.default.change("wife_jiaqi", t.num > 0);
        ...
        t.prototype.sendUpSkill = function (t, e) {
        ...
        t.prototype.sendWeige = function () {
            var t = new proto_cs.wife.weige();
            JsonHttp.send(t);
        };
        t.prototype.sendYJCY = function () {
            var t = new proto_cs.wife.yjxxoogetbaby();
            JsonHttp.send(t);
        };
        t.prototype.sendSJCY = function () {
            var t = new proto_cs.wife.sjcy();
            JsonHttp.send(t);
        };
        t.prototype.sendJiaQi = function (t) {
        ...
        t.prototype.sendWifeTalk = function (t) {
            var e = new proto_cs.wife.wchat();
            e.id = t;
            JsonHttp.send(e);
        };
        t.prototype.sendJbGift = function (t, e, o) {
        ...
        t.prototype.getMarryList = function (t) {
            for (
                var e = localcache.getList(localdb.table_wife), o = [], i = 0; i < e.length; i++
            ) {
                var n = e[i];
                if (0 != n.open) {
        ...
        t.prototype.getWifeData = function (t) {
            return this.wifeMaps.get(t + "");
        };
        t.prototype.onHello = function (t) {
            i.utils.openPrefabView("wife/WifeWenHouView", !1, t);
            facade.send(this.WIFE_WINDOW);
        };
        t.prototype.onTravel = function (t) {
            i.utils.openPrefabView("wife/WifeChuYouView", !1, t);
            facade.send(this.WIFE_WINDOW);
        };
        t.prototype.getQishiWife = function () {
        ...
        t.prototype.getGiftList = function (t, e) {
            for (
                var o = [], i = localcache.getList(localdb.table_item), n = 0; n < i.length; n++
            )
                if ("wife" == i[n].type[0]) {
                    var l = {
                        id: i[n].id
