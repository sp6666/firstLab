...
var i = require("../utils/Utils"),
    ...
    r = (function() {
        ...
        t.prototype.onG2dft = function(t) {
            null == this.g2dft
                ? (this.g2dft = t)
                : i.utils.copyList(this.g2dft, t);
            facade.send(this.UPDATE_BOSS_G2DFT);
        };
        t.prototype.onG2dkill = function(t) {
            this.g2dKill = t;
            facade.send(this.UPDATE_BOSS_G2DFT);
        };
        t.prototype.onGe2dan = function(t) {
            this.ge2dan = t;
            l.default.change("boss_start", 2 == t.state);
            facade.send(this.UPDATE_BOSS_GE2DAN);
        };
        t.prototype.onGe2danMyDmg = function(t) {
            this.ge2danMyDmg = t;
            facade.send(this.UPDATE_BOSS_GE2DANMYDMG);
        };
        t.prototype.onHurtRank = function(t) {
            this.hurtRank = t;
            facade.send(this.UPDATE_BOSS_HURTRANK);
        };
        t.prototype.onMengGu = function(t) {
            this.menggu = t;
            facade.send(this.UPDATE_BOSS_MENGGU);
        };
        t.prototype.onMggt = function(t) {
            this.mgft = t;
        ...
        t.prototype.sendComeBackG2D = function(t) {
            var e = new proto_cs.wordboss.comebackg2d();
            e.id = t;
            JsonHttp.send(e);
        };
        t.prototype.sendComeBackMG = function(t) {
            var e = new proto_cs.wordboss.comebackmg();
            e.id = t;
            JsonHttp.send(e);
        };
        t.prototype.sendG2dHitRank = function(t) {
            void 0 === t && (t = !1);
            var e = this;
        ...
        t.prototype.sendShopBuyShopBuy = function(t) {
        ...
        t.prototype.sendWordBoss = function() {
            JsonHttp.send(new proto_cs.wordboss.wordboss());
        };
        t.prototype.getBuyCount = function(t) {
        ...
        t.prototype.getServantHitCount = function(t, e, o) {
            void 0 === e && (e = !1);
        ...
        t.prototype.getHitData = function(t) {
        ...
        t.prototype.getServantBuyCount = function(t) {
