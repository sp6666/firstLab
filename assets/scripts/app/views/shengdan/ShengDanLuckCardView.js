...
var i = require("../../component/List"),
    ...
    _ = (function(t) {
        ...
        e.prototype.onLoad = function() {
            ...
            var t = this;
            facade.subscribe(
                l.shengDanProxy.SHENGDAN_LEVELDATA,
                this.onDataUpdate,
                this
            );
            ...
            this.list.selectHandle = function(e) {
                ...
                if (!l.shengDanProxy.getIsEnough(t.currentLevel)) {
                    n.alertUtil.alert18n("SHENGDAN_XINGCHENGBUZU");
                    return;
                }
                if (t.flag) return;
                t.flag = true;
                ...
                if (
                    n.timeUtil.second >=
                    l.shengDanProxy.data.info.showTime
                ) {
                    n.alertUtil.alert18n("ACTHD_OVERDUE");
                    return;
                }
                l.shengDanProxy.sendGetRewad(t.currentLevel + 1, t.currentPage + 1, i + 1);
            };
        ...
        e.prototype.gotoNext = function() {
            this.currentLevel ++;
            if(l.shengDanProxy.getMostLevel() == 8) {
                //第八关已打开
                this.currentLevel = 7;
            }
            this.currentPage = 0;
            this.data = l.shengDanProxy.getCurrentLevelData(this.currentLevel);
            this.totalPage = this.data.page;
            this.initCurrentTag();
        };
        ...
        e.prototype.start = function() {
            ...
            if(l.shengDanProxy.level_data.is_pass == 1) {
                l.shengDanProxy.level_data.is_pass = 0;
            }
            this.initCurrentTag();
        };

        e.prototype.initCurrentTag = function() {
            l.shengDanProxy.reset = true;
            this.initList();
        ...
        e.prototype.onDataUpdate = function() {
            ...
            var data = l.shengDanProxy.getCurrentTagData(this.currentLevel, this.currentPage, this.data.count);
            ...
            this.lblLevel.string = i18n.t("SHENGDAN_LEVE", {level : this.currentLevel + 1});
            if(this.currentLevel == 7) {
                //第八关
                this.lblLevel.string = i18n.t("SHENGDAN_LEVENOLIMIT");
            }
            this.lblTag.string = i18n.t("SHENGDAN_TAG", {tag : this.currentPage + 1});
            this.lblCost.string = i18n.t("SHENGDAN_LEVELCOST", {num : l.shengDanProxy.getNeed(this.currentLevel)});
            this.lblTreeLeft.string = i18n.t("SHENGDAN_TREELEFT", {num : l.shengDanProxy.getCurrentTreeLeft(this.currentLevel)});
            this.lblBoxLeft.string = i18n.t("SHENGDAN_BOXLEFT", {num : l.shengDanProxy.getCurrentBoxLeft(this.currentLevel, this.currentPage)});

            this.btnRefresh.node.active = l.shengDanProxy.getRefreshBtnShow(this.currentLevel);
            if(this.currentLevel == 7) {
            ...
            l.shengDanProxy.reset = false;
            if(l.shengDanProxy.isBoxOpen()) {
                //播放动画
        ...
        e.prototype.checkPass = function() {
            ...
            if(l.shengDanProxy.isAlertPass()) {
                if(this.currentLevel == 7) {
                    //第八关
