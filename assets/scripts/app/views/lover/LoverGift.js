...
cc.Class({
    ...
    onLoad : function () {
        ...
        facade.subscribe(n.loverProxy.LOVER_ON_FRIEND_LIST_SELECTED,this.onChooseFriend,this);
    ...
    onShowData: function(){
        this.list.data = n.loverProxy.foodList;
    },



    onClickClose: function() {
        n.loverProxy.clearUserData();
        u.utils.closeView(this);
    },

    onClickFriend : function() {
        u.utils.openPrefabView("lover/LoverCommonFriendChooseView", false);  
    },
    ...
    onChooseFriend : function (t) {
        ...
        n.loverProxy.userData = t;
        n.loverProxy.userId = t.id;
