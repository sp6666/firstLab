    ...
    _ = (function (t) {
        ...
        e.prototype.showData = function () {
            ...
            this.lblFuQi.string =
                ...
                ":(" +
                l.loverProxy.myRank.score +
                "/" +
                t.need +
                ")";
            this.btnLinQu.node.active =
                l.loverProxy.myRank.score >= t.need && !t.get;
            this.btnNoLinQu.active = l.loverProxy.myRank.score < t.need;
            this.btnYiLinQu.node.active =
                l.loverProxy.myRank.score >= t.need && 1 == t.get;
            r.shaderUtils.setImageGray(this.btnNoLinQuImg);
        };
        e.prototype.onClickLingQu = function () {
            var t = this._data;
            l.loverProxy.sendLingQu(t.id);
            this.btnLinQu.node.active =
                l.loverProxy.myRank.score >= t.need && !t.get;
            this.btnYiLinQu.node.active =
                l.loverProxy.myRank.score >= t.need && 1 == t.get;
