...
var i = require("../../component/List"),
    ...
    c = (function(t) {
        ...
        e.prototype.onLoad = function() {
            facade.subscribe(l.bishuProxy.BISHU_MY_RID, this.onRank, this);
            this.onRank();
            this.onTimer();
        ...
        e.prototype.onRank = function() {
            ...
            var t =
                null == l.bishuProxy.myRid
                    ? 0
                    : null == l.bishuProxy.myRid.rid
                    ? 0
                    : l.bishuProxy.myRid.rid;
            this.lblMyRank.string = 0 == t ? i18n.t("RAKN_UNRANK") : t + "";
            this.lblMyScore.string = l.bishuProxy.myRid
                ? l.bishuProxy.myRid.score + ""
                : "0";
            this.list.data = l.bishuProxy.ranks;
        };
        e.prototype.onClickClose = function() {
            n.utils.closeView(this);
        };
        e.prototype.onClickRe = function() {
            l.rankProxy.sendRefresh(l.bishuProxy.cfg.info.id);
        };
