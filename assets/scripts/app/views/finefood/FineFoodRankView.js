...
var i = require("../../component/List"),
    ...
    c = (function (t) {
        ...
        e.prototype.onLoad = function () {
            facade.subscribe(l.fineFoodProxy.FINE_FOOD_MY_RID, this.onRank, this);
            this.onRank();
            this.onTimer();
        ...
        e.prototype.onRank = function () {
            ...
            var t =
                null == l.fineFoodProxy.myRid ?
                0 :
                null == l.fineFoodProxy.myRid.rid ?
                0 :
                l.fineFoodProxy.myRid.rid;
            this.lblMyRank.string = 0 == t ? i18n.t("RAKN_UNRANK") : t + "";
            this.lblMyScore.string = l.fineFoodProxy.myRid ?
                l.fineFoodProxy.myRid.score + "" :
                "0";
            this.list.data = l.fineFoodProxy.rank;
        };
        e.prototype.onClickClose = function () {
            n.utils.closeView(this);
        };
        e.prototype.onClickRe = function () {
            l.rankProxy.sendRefresh(l.fineFoodProxy.data.info.id);
        };
