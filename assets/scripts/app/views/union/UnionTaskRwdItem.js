    ...
    d = (function (t) {
        ...
        e.prototype.showData = function () {
            ...
            if (t) {
                ...
                if (t.id === 32) {
                    this.lblSpeCount.node.active = true;
                    this.lblCount.node.active = false;
                    this.urlload.node.active = false;
                    this.itemslot.node.active = false;

                    this.lblSpeCount.string = this.lblCount.string = i18n.t("UNION_GE_REN_GONG_XIAN_2", {
                        num: t.count
                    });
                } else {
                    ...
                    this.lblSpeCount.node.active = false;
                    this.lblCount.node.active = true;
                    this.urlload.node.active = true;
        ...
        __decorate([_(cc.Label)], e.prototype, "lblSpeCount", void 0);
