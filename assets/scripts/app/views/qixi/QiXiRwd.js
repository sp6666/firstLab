...
var i = require("../../component/List"),
    ...
    _ = (function(t) {
        ...
        e.prototype.updateMyScore = function() {
            this.lblFuQi.string =
                i18n.t("HEDENG_LEI_JI_JI_FEN") + ":" + r.qixiProxy.myRid.score;
            this.lblPaiMing.string =
                i18n.t("ARBOR_DAY_CUR_RANK") + ":" + r.qixiProxy.myRid.rid;
            this.lblTime.string = i18n.t("AT_LIST_ACTIVITY_CD");
            var t = this;
            l.uiUtils.countDown(
                r.qixiProxy.data.info.eTime,
                this.lblTime,
                function() {
