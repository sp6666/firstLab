...
var i = require("../../component/RenderListItem"),
    ...
    c = (function(t) {
                ...
                if (1 == t) {
                    ...
                    var l = e.aep.e1 + e.aep.e2 + e.aep.e3 + e.aep.e4,
                        r = localcache.getItem(
                            localdb.table_powerStar,
                            this.heroSys.star
                        ),
                        a = Math.floor(
                            (o.power / n.servantProxy.servantList.length) *
                                (r.point / 1e4)
                        );
                    this.lblValue.string = i18n.t("COMMON_NUM", {
                        f: l,
                    ...
                    for (
                        var c = localcache.getGroup(
                                localdb.table_wifeSkill,
                                "heroid",
                                this.heroSys.heroid
                            )[0].wid,
                            _ = n.wifeProxy.getWifeData(c),
                            d = 0,
                            u = 0;
                        u < _.skill.length;
                        u++
        ...
        __decorate([s(cc.Label)], e.prototype, "lblValue", void 0);
        __decorate([s(cc.Label)], e.prototype, "lblShili", void 0);
        __decorate([s(cc.ProgressBar)], e.prototype, "proBar", void 0);
