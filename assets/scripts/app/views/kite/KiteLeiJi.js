...
var i = require("../../component/List"),
    ...
    _ = (function (t) {
        ...
        e.prototype.onLoad = function () {
            ...
            var t = Math.ceil(r.kiteProxy.data.total[0].items.length / 6),
                e = 80 * t + 10 * (t - 1) + 65;
        ...
        e.prototype.updateMyScore = function () {
            r.kiteProxy.data.total.sort(this.sortHuoDong);
            this.list.data = r.kiteProxy.data.total;
            var t = this;
            l.uiUtils.countDown(
            ...
            this.lblFuQi.string =
                i18n.t("COMMON_LEI_JI_FU_LI") + ":" + r.kiteProxy.data.cons;
        };
