...
var i = require("../../component/List"),
    ...
    c = (function (t) {
        ...
        e.prototype.onLoad = function () {
            facade.subscribe(l.kiteProxy.KITE_RANK, this.onRank, this);
            facade.subscribe(l.kiteProxy.KITE_MY_RID, this.onMyRid, this);
            this.onRank();
            this.onMyRid();
            this.onTimer();
        ...
        e.prototype.onRank = function () {
            this.list.data = l.kiteProxy.rank;
            var t = l.limitActivityProxy.getActivityData(
                    l.limitActivityProxy.KITE_ID
                ),
                e = !!t &&
        ...
        e.prototype.onMyRid = function () {
            ...
            var t =
                null == l.kiteProxy.myRid ?
                0 :
                null == l.kiteProxy.myRid.rid ?
                0 :
                l.kiteProxy.myRid.rid;
            this.lblMyRank.string = 0 == t ? i18n.t("RAKN_UNRANK") : t + "";
            this.lblMyScore.string = l.kiteProxy.myRid ?
                l.kiteProxy.myRid.score + "" :
                "0";
        };
        ...
        e.prototype.onClickRe = function () {
            l.rankProxy.sendRefresh(l.kiteProxy.data.info.id);
        };
