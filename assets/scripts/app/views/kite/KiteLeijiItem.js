...
var i = require("../../component/RenderListItem"),
    ...
    _ = (function (t) {
        ...
        e.prototype.showData = function () {
            ...
            var count = l.kiteProxy.myRid.score;
            // l.kiteProxy.base.damage.forEach(element => {
            //     if(element){
            //         count+=element.count;
            //     }
            // });
            ...
            this.btnLinQu.node.active =
                count >= t.need && !t.get;
            this.btnNoLinQu.active = count < t.need;
        ...
        e.prototype.onClickLingQu = function () {
            var t = this._data;
            l.kiteProxy.sendLingQu(t.id);
            this.btnLinQu.node.active =
                l.kiteProxy.myRid.score >= t.need && !t.get;
            this.btnYiLinQu.node.active =
                l.kiteProxy.myRid.score >= t.need && 1 == t.get;
        };
