...
var i = require("../../utils/Utils"),
    ...
    c = (function (t) {
        ...
        e.prototype.onLoad = function () {
            facade.subscribe(
                n.qixiProProxy.QIXI_PRO_DATA_UPDATE,
                this.onDataUpdate,
                this
            );
            facade.subscribe(n.qixiProProxy.QIXI_PRO_ITEM_RED, this.onItemRed, this);
        ...
        e.prototype.onDataUpdate = function () {
            ...
            if (e) {
                ...
                this.lblBall.string =
                    n.bagProxy.getItemCount(n.qixiProProxy.data.need) + "";
                this.tipNode.active =
                    0 == n.bagProxy.getItemCount(n.qixiProProxy.data.need);
            }
            if (this.bClick) {
                this.bClick = !1;
                i.utils.openPrefabView("qixiPro/QiXiProChouQian");
            }
        };
        e.prototype.onActData = function () {};
        e.prototype.onItemRed = function () {};
        e.prototype.onItemUpdate = function () {
            if (n.qixiProProxy.data) {
                var t = n.bagProxy.getItemCount(n.qixiProProxy.data.need);
                this.tipNode.active = 0 == t;
                this.lblBall.string = t + "";
            }
        };
        e.prototype.onClickQian = function (t, e) {
            if (this.denging) i.alertUtil.alert18n("QIXI_PRO_BUILDING");
            else if (null != n.qixiProProxy.data) {
                ...
                if (
                    ...
                    i.alertUtil.alertItemLimit(n.qixiProProxy.data.need);
                    this.onClickAdd();
                }
            }
        };
        e.prototype.onTimer = function () {
            this.denging = !1;
            n.qixiProProxy.sendQIXI(this.dengNum);
        };
            ...
            switch (e) {
                case "0":
                    i.utils.openPrefabView(
                        "ActivityShopView",
                        null,
                        n.qixiProProxy.dhShop
                    );
                    break;

                case "1":
                    var o = n.limitActivityProxy.QIXI_PRO_TYPE;
                    i.utils.openPrefabView(
                ...
                case "2":
                case "3":
                    n.qixiProProxy.sendPaiHang(e);
            }
        };
        e.prototype.onClickAdd = function () {
            i.utils.openPrefabView("ActivitySpecialBuy", null, {
                data: n.qixiProProxy.shop[0],
                activityId: n.qixiProProxy.data.info.id
            });
            n.shopProxy.openShopBuy(n.qixiProProxy.data.need);
        };
