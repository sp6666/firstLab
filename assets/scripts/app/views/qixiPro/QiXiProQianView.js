...
var i = require("../../utils/Utils"),
    ...
    s = (function (t) {
        ...
        e.prototype.updateMyScore = function () {
            if (1 == n.qixiProProxy.result.draw.length) this.tenNode.active = !1;
            else {
                this.oneNode.active = !1;
                for (var t = 0; t < n.qixiProProxy.result.draw.length; t++) {
                    var e = cc.instantiate(this.TenPrefabs);
                    this.tenNodeQian.addChild(e);
                    e.getComponent("QiXiProChouQianItem").setSprite(t);
                }
            }
        };
