...
var i = require("../../component/List"),
    ...
    _ = (function (t) {
        ...
        e.prototype.onLoad = function () {
            facade.subscribe(
                r.qixiProProxy.QIXI_PRO_OPEN_PAIHANG,
                this.updateMyScore,
                this
            );
            var t = Math.ceil(r.qixiProProxy.data.rankRwd[0].member.length / 6),
                e = 100 * t + 10 * (t - 1) + 65;
            this.list.setWidthHeight(550, e);
            this.list.data = r.qixiProProxy.data.rankRwd;
            this.updateMyScore();

            this.lblDate.string =
                n.timeUtil.format(
                    r.qixiProProxy.data.info.sTime,
                    "yyyy-MM-dd"
                ) +
                i18n.t("COMMON_ZHI") +
                n.timeUtil.format(r.qixiProProxy.data.info.eTime, "yyyy-MM-dd");
        };
        e.prototype.onClickRank = function () {
            n.utils.openPrefabView("qixiPro/QiXiProRankView");
        };
        e.prototype.updateMyScore = function () {
            this.lblFuQi.string = '' + r.qixiProProxy.myRid.score;
            this.lblPaiMing.string = '' + r.qixiProProxy.myRid.rid;
            this.lblTime.string = i18n.t("AT_LIST_ACTIVITY_CD");
            var t = this;
            l.uiUtils.countDown(
                r.qixiProProxy.data.info.eTime,
                this.lblTime,
                function () {
