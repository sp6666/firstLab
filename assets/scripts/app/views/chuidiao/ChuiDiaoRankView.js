...
var i = require("../../component/List"),
    ...
    c = (function(t) {
        ...
        e.prototype.onLoad = function() {
            facade.subscribe(l.chuidiaoProxy.CHUIDIAO_MY_RID, this.onRank, this);
            this.onRank();
            this.onTimer();
        ...
        e.prototype.onRank = function() {
            ...
            var t =
                null == l.chuidiaoProxy.myRid
                    ? 0
                    : null == l.chuidiaoProxy.myRid.rid
                    ? 0
                    : l.chuidiaoProxy.myRid.rid;
            this.lblMyRank.string = 0 == t ? i18n.t("RAKN_UNRANK") : t + "";
            this.lblMyScore.string = l.chuidiaoProxy.myRid
                ? l.chuidiaoProxy.myRid.score + ""
                : "0";
            this.list.data = l.chuidiaoProxy.rank;
        };
        e.prototype.onClickClose = function() {
            n.utils.closeView(this);
        };
        e.prototype.onClickRe = function() {
            l.rankProxy.sendRefresh(l.chuidiaoProxy.data.info.id);
        };
