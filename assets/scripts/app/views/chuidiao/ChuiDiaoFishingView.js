...
var n = require("../../utils/Utils"),
    ...
    fishing = require("./ChuiDiaoFishingArea"),
    r = cc._decorator,
    a = r.ccclass,
    s = r.property,
    c = (function(t) {
        ...
        e.prototype.onLoad = function() {
            ...
            facade.subscribe(l.chuidiaoProxy.CHUIDIAO_FISHING_BACK, this.onClickClose, this);

            var t = this.node.openParam;
            if (t) {
               this.data = localcache.getItem(localdb.table_chuidiao_msg, t);
               this.sevData = l.chuidiaoProxy.cities[t];
               this.updateData();
            }
        };
        //这里更新钓竿数量
        e.prototype.onItemUpdate = function() {
            this.lblRodsCount.string = l.bagProxy.getItemCount(l.chuidiaoProxy.data.settings.fishing.rod) + "";
        };
        ...
        e.prototype.updateData = function(){
            ...
            //提示
            this.lblDes.string = this.data.des;
            ...
            if(this.sevData.fishes.special)
            {
                ...
                if(item)
                {
                    this.fishing.setTip(i18n.t("CHUIDIAO_FISH_TIP1", { name: item.name}));
                }
            }
        ...
        e.prototype.onClickLook = function(t, e) {
            ...
            var needProp = l.bagProxy.getItemCount(l.chuidiaoProxy.data.settings.fishing.rod);  //当前道具数量
            if (needProp < times)
            {
                //如果钓竿不够弹提示
                n.alertUtil.alertItemLimit(l.chuidiaoProxy.data.settings.fishing.rod);
                this.onClickCharge();
            }
            else
            {
        ...
        e.prototype.onClickCharge = function(){
            n.utils.openPrefabView("ActivitySpecialBuy", null, {
                data: l.chuidiaoProxy.shop[0],
                activityId: l.chuidiaoProxy.data.info.type
            });
        };
