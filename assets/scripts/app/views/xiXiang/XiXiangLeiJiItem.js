    ...
    _ = (function (t) {
        ...
        e.prototype.showData = function () {
            ...
            this.lblFuQi.string =
                ...
                ":(" +
                l.xiXiangProxy.ljjlData.cons +
                "/" +
                t.need +
                ")";
            this.btnLinQu.node.active =
                l.xiXiangProxy.ljjlData.cons >= t.need && l.xiXiangProxy.ljjlData.score_rwd_got[t.id] == null;
            this.btnNoLinQu.active = l.xiXiangProxy.ljjlData.cons < t.need;
        ...
        e.prototype.onClickLingQu = function () {
            var t = this._data;
            l.xiXiangProxy.sendLingQu(t.id);
            this.btnLinQu.node.active =
                l.xiXiangProxy.ljjlData.cons >= t.need && l.xiXiangProxy.ljjlData.score_rwd_got[t.id] == null;
            this.btnYiLinQu.node.active =
                l.xiXiangProxy.ljjlData.cons >= t.need &&  l.xiXiangProxy.ljjlData.score_rwd_got[t.id] != null;
