...
var i = require("../../component/List"),
    ...
    c = (function (t) {
        ...
        e.prototype.onLoad = function () {
            ...
            facade.subscribe(l.xiXiangProxy.XIXIANG_RANK, this.onRank, this);
            facade.subscribe(l.xiXiangProxy.XIXIANG_MY_RID, this.onMyRid, this);
            this.changeRankType();
            this.showHeads();
            this.onRank();
            this.onMyRid();
        ...
        e.prototype.onRank = function () {
            ...
            this.list.data = l.xiXiangProxy.finalRank[this.servantIndex];


            var t = l.limitActivityProxy.getActivityData(
                    l.limitActivityProxy.XIXIANG_ID
                ),
                e = !!t &&
            ...
            this.listRwd.data = l.xiXiangProxy.data.rwd;

        };
        e.prototype.onMyRid = function () {
            this.lblMyName.string = l.playerProxy.userData.name;
            if (!l.xiXiangProxy.myRid) {
                this.lblMyRank.string = i18n.t("RAKN_UNRANK");
                this.lblMyScore.string = 0;
            } else {
                var t =
                    null == l.xiXiangProxy.myRid[this.servantIndex] ?
                    0 :
                    null == l.xiXiangProxy.myRid[this.servantIndex].rid ?
                    0 :
                    l.xiXiangProxy.myRid[this.servantIndex].rid;
                this.lblMyRank.string = 0 == t ? i18n.t("RAKN_UNRANK") : t + "";
                this.lblMyScore.string = l.xiXiangProxy.myRid[this.servantIndex] ?
                    l.xiXiangProxy.myRid[this.servantIndex].score + "" :
                    "0";
            }
        ...
        e.prototype.onClickRe = function () {
            ...
            this.onTimer();
            */
            l.rankProxy.sendRefresh(l.xiXiangProxy.data.info.no);
        };
