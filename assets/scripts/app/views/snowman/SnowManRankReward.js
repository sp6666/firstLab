...
var i = require("../../component/List"),
    ...
    _ = (function (t) {
        ...
        e.prototype.onLoad = function () {
            facade.subscribe(
                r.snowmanProxy.SNOWMAN_MY_RANK,
                this.onRank,
                this
            );
            r.snowmanProxy.sendLookRank();
            this.lbldate.string =
                n.timeUtil.format(
                    r.snowmanProxy.data.info.sTime,
                    "yyyy-MM-dd"
                ) +
                i18n.t("COMMON_ZHI") +
                n.timeUtil.format(r.snowmanProxy.data.info.eTime, "yyyy-MM-dd");
            var t = this;
            l.uiUtils.countDown(
                r.snowmanProxy.data.info.eTime,
                this.lblcd,
                function () {
            ...
            var e = 0,
                o = r.snowmanProxy.data.rwd[0].member.length,
        ...
        e.prototype.showItem = function () {
            this.list.data = r.snowmanProxy.data.rwd;
        };

        e.prototype.onRank = function () {
            this.lblMyRank.string = r.snowmanProxy.myRank.rid ?
                r.snowmanProxy.myRank.rid + "" :
                i18n.t("RAKN_UNRANK");

            this.lblMyScore.string = r.snowmanProxy.myRank.score + "";

        };
        e.prototype.onClickRank = function () {
            n.utils.openPrefabView("limitactivity/AtListRankView", null, {
                isTangYuan: !0,
                id: r.snowmanProxy.data.info.type
            });
        };
