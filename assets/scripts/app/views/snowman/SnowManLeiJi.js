...
var i = require("../../component/List"),
    ...
    _ = (function (t) {
        ...
        e.prototype.onLoad = function () {
            facade.subscribe(
                r.snowmanProxy.SNOWMAN_DATA_UPDATE,
                this.updateMyScore,
                this
            );
            var t = Math.ceil(r.snowmanProxy.data.total[0].items.length / 6),
                e = 80 * t + 10 * (t - 1) + 65;
        ...
        e.prototype.updateMyScore = function () {
            r.snowmanProxy.data.total.sort(this.sortHuoDong);
            this.list.data = r.snowmanProxy.data.total;
            var t = this;
            l.uiUtils.countDown(
            ...
            this.lblFuQi.string =
                i18n.t("HEDENG_LEI_JI_FU_LI") + ":" + r.snowmanProxy.data.cons;
        };
