    ...
    c = (function(t) {
        ...
        e.prototype.onRank = function() {
            ...
            var t = l.limitActivityProxy.getActivityData(
                    l.limitActivityProxy.HEDENG_ID
                ),
                e =
                    !!t &&
        ...
        e.prototype.onMyRid = function() {
            ...
            var t =
                null == l.hedengProxy.myRid
                    ? 0
                    : null == l.hedengProxy.myRid.rid
                    ? 0
                    : l.hedengProxy.myRid.rid;
            this.lblMyRank.string = 0 == t ? i18n.t("RAKN_UNRANK") : t + "";
            this.lblMyScore.string = l.hedengProxy.myRid
                ? l.hedengProxy.myRid.score + ""
                : "0";
        };
