...
var i = require("../../component/List"),
    ...
    c = (function (t) {
        ...
        e.prototype.onLoad = function () {
            facade.subscribe(l.queenProxy.QUEEN_RANK, this.onRank, this);
            facade.subscribe(l.queenProxy.QUEEN_MY_RID, this.onMyRid, this);
            this.onRank();
            this.onMyRid();
            this.onTimer();
        ...
        e.prototype.onRank = function () {
            this.list.data = l.queenProxy.rank;
            var t = l.limitActivityProxy.getActivityData(
                    l.limitActivityProxy.QUEEN_ID
                ),
                e = !!t &&
        ...
        e.prototype.onMyRid = function () {
            ...
            var t =
                null == l.queenProxy.myRid ?
                0 :
                null == l.queenProxy.myRid.rid ?
                0 :
                l.queenProxy.myRid.rid;
            this.lblMyRank.string = 0 == t ? i18n.t("RAKN_UNRANK") : t + "";
            this.lblMyScore.string = l.queenProxy.myRid ?
                l.queenProxy.myRid.score + "" :
                "0";
        };
        ...
        e.prototype.onClickRe = function () {
            l.rankProxy.sendRefresh(l.queenProxy.data.info.id);
        };
