    ...
    _ = (function (t) {
        ...
        e.prototype.showData = function () {
            ...
            this.btnLinQu.node.active =
                l.queenProxy.myRid.score >= t.need && !t.get;
            this.btnNoLinQu.active = l.queenProxy.myRid.score < t.need;
            this.btnYiLinQu.node.active =
                l.queenProxy.myRid.score >= t.need && 1 == t.get;
            r.shaderUtils.setImageGray(this.btnNoLinQuImg);
        };
        e.prototype.onClickLingQu = function () {
            var t = this._data;
            l.queenProxy.sendLingQu(t.id);
            this.btnLinQu.node.active =
                l.queenProxy.myRid.score >= t.need && !t.get;
            this.btnYiLinQu.node.active =
                l.queenProxy.myRid.score >= t.need && 1 == t.get;
