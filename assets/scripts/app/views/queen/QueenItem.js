    ...
    c = (function (t) {
        ...
        Object.defineProperty(e.prototype, "select", {
            set: function (t) {
                ...
                if (this.eff) {
                    ...
                    t && (this.eff.setAnimation(0, 'yici', false));
                }
            },
            enumerable: !0,
            configurable: !0
        ...
        e.prototype.showData = function () {
            ...
            if (t) {
                ...
                this.itemSlot.node.rotation = -this.node.rotation;
                if (this.lastData) {
                    if (this.lastData.id != t.id || this.lastData.count != t.count) {
                        if (this.eff) {
                            this.eff.node.active = true;
                            this.eff.setAnimation(0, 'yici', false);
                        }
                    }
                }

                this.lastData = this._data;
