...
var i = require("../../component/List"),
    ...
    _ = (function(t) {
        ...
        e.prototype.onLoad = function() {
            facade.subscribe(
                r.sakuraProxy.SAKURA_MYRANK,
                this.onRank,
                this
            );
            r.sakuraProxy.sendRank();
            this.lbldate.string =
                n.timeUtil.format(
                    r.sakuraProxy.data.info.sTime,
                    "yyyy-MM-dd"
                ) +
                i18n.t("COMMON_ZHI") +
                n.timeUtil.format(r.sakuraProxy.data.info.eTime, "yyyy-MM-dd");
            var t = this;
            l.uiUtils.countDown(
            ...
            this.list.data = r.sakuraProxy.data.rank_rwd;

            var e = 0,
            o = r.sakuraProxy.data.rank_rwd[0].member.length,
        ...
        e.prototype.onRank = function() {
            this.lblMyRank.string = r.sakuraProxy.myRank.rid
                ? r.sakuraProxy.myRank.rid + ""
                : i18n.t("RAKN_UNRANK");
                this.lblMyScore.string = r.sakuraProxy.myRank.score + "";
        };
        e.prototype.onClickRank = function() {
            n.utils.openPrefabView("limitactivity/AtListRankView", null, {
                isTangYuan: !0,
                id: r.sakuraProxy.data.info.type
            });
        };
