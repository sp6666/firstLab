...
var i = require("../../component/List"),
    ...
    _ = (function(t) {
        ...
        e.prototype.onLoad = function() {
            facade.subscribe(
                r.liangxiaoProxy.LIANGXIAO_MY_RANK,
                this.onRank,
                this
            );
            r.liangxiaoProxy.sendLookRank();
            this.lbldate.string =
                n.timeUtil.format(
                    r.liangxiaoProxy.info.info.sTime,
                    "yyyy-MM-dd"
                ) +
                i18n.t("COMMON_ZHI") +
                n.timeUtil.format(r.liangxiaoProxy.info.info.eTime, "yyyy-MM-dd");
            var t = this;
            l.uiUtils.countDown(
            ...
            this.list.data = r.liangxiaoProxy.info.rwd;
        };
        e.prototype.onRank = function() {
            this.lblMyRank.string = r.liangxiaoProxy.myRank.rid
                ? r.liangxiaoProxy.myRank.rid + ""
                : i18n.t("RAKN_UNRANK");
        };
        e.prototype.onClickRank = function() {
            n.utils.openPrefabView("limitactivity/AtListRankView", null, {
                isTangYuan: !0,
                id: r.liangxiaoProxy.info.info.id
            });
        };
