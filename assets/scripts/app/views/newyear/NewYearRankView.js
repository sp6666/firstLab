...
var i = require("../../component/List"),
    ...
    c = (function (t) {
        ...
        e.prototype.onLoad = function () {
            facade.subscribe(l.newYearProxy.NEW_YEAR_RANK, this.onRank, this);
            facade.subscribe(l.newYearProxy.NEW_YEAR_MY_RID, this.onMyRid, this);
            this.onRank();
            this.onMyRid();
            this.onTimer();
        ...
        e.prototype.onRank = function () {
            this.list.data = l.newYearProxy.rank;
            var t = l.limitActivityProxy.getActivityData(
                    l.limitActivityProxy.NEW_YEAR_ID
                ),
                e = !!t &&
        ...
        e.prototype.onMyRid = function () {
            ...
            var t =
                null == l.newYearProxy.myRid ?
                0 :
                null == l.newYearProxy.myRid.rid ?
                0 :
                l.newYearProxy.myRid.rid;
            this.lblMyRank.string = 0 == t ? i18n.t("RAKN_UNRANK") : t + "";
            this.lblMyScore.string = l.newYearProxy.myRid ?
                l.newYearProxy.myRid.score + "" :
                "0";
        };
        ...
        e.prototype.onClickRe = function () {
            l.rankProxy.sendRefresh(l.newYearProxy.data.info.id);
        };
