...
var i = require("../../component/List"),
    ...
    _ = (function (t) {
        ...
        e.prototype.onLoad = function () {
            ...
            var t = Math.ceil(r.newYearProxy.data.total[0].items.length / 6),
                e = 80 * t + 10 * (t - 1) + 65;
            this.list.setWidthHeight(550, e);
            this.updateMyScore();
        };
        e.prototype.onClickRank = function () {
            n.utils.openPrefabView("newyear/NewYearView");
        };
        e.prototype.sortHuoDong = function (t, e) {
            return t.get != e.get ? t.get - e.get : t.id - e.id;
        };
        e.prototype.updateMyScore = function () {
            r.newYearProxy.data.total.sort(this.sortHuoDong);
            this.list.data = r.newYearProxy.data.total;
            var t = this;
            l.uiUtils.countDown(
            ...
            this.lblFuQi.string =
                i18n.t("NEW_YEAR_LEI_JI_FU_LI") + ":" + r.newYearProxy.data.cons;
        };
