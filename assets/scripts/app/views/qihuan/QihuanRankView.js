...
var i = require("../../component/List"),
    ...
    c = (function (t) {
        ...
        e.prototype.onLoad = function () {
            ...
            facade.subscribe(l.qihuanProxy.QIHUAN_RANK, this.onRank, this);
            facade.subscribe(l.qihuanProxy.QIHUAN_MY_RID, this.onMyRid, this);
            this.changeRankType();
            this.showHeads();
            this.onRank();
            this.onMyRid();
        ...
        e.prototype.onRank = function () {
            ...
            this.list.data = l.qihuanProxy.finalRank[this.servantIndex];


            var t = l.limitActivityProxy.getActivityData(
                    l.limitActivityProxy.QIHUAN_ID
                ),
                e = !!t &&
            ...
            this.listRwd.data = l.qihuanProxy.data.rwd;

        };
        e.prototype.onMyRid = function () {
            this.lblMyName.string = l.playerProxy.userData.name;
            if (!l.qihuanProxy.myRid) {
                this.lblMyRank.string = i18n.t("RAKN_UNRANK");
                this.lblMyScore.string = 0;
            } else {
                var t =
                    null == l.qihuanProxy.myRid[this.servantIndex] ?
                    0 :
                    null == l.qihuanProxy.myRid[this.servantIndex].rid ?
                    0 :
                    l.qihuanProxy.myRid[this.servantIndex].rid;
                this.lblMyRank.string = 0 == t ? i18n.t("RAKN_UNRANK") : t + "";
                this.lblMyScore.string = l.qihuanProxy.myRid[this.servantIndex] ?
                    l.qihuanProxy.myRid[this.servantIndex].score + "" :
                    "0";
            }
        ...
        e.prototype.onClickRe = function () {
            ...
            this.onTimer();
            */
            l.rankProxy.sendRefresh(l.qihuanProxy.data.info.no);
        };
