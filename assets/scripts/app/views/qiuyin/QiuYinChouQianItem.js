...
var i = require("../../Initializer"),
    ...
    c = (function(t) {
        ...
        e.prototype.setSprite = function(t) {
            var e = i.qiuyinProxy.result.draw[t].type,
                o = i.qiuyinProxy.result.draw[t].hid,
                n = i.qiuyinProxy.result.draw[t].id;
            this.head.url = l.uiHelps.getServantHead(o);
            this.qian.url = l.uiHelps.getChouQianImg(e, n,"qiuyin");
