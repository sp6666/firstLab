...
var i = require("../../Initializer"),
    ...
    c = (function(t) {
        ...
        e.prototype.setSprite = function() {
            var t = i.qiuyinProxy.result.draw[0].type,
                e = i.qiuyinProxy.result.draw[0].hid,
                o = i.qiuyinProxy.result.draw[0].id;
            console.log(t, e, o, i.qiuyinProxy.result);
            this.head.url = l.uiHelps.getServantHead(e);
            this.qian.url = l.uiHelps.getChouQianImg(t, o,"qiuyin");
