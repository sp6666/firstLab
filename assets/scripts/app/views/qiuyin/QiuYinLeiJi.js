...
var i = require("../../component/List"),
    ...
    c = (function(t) {
        ...
        e.prototype.onLoad = function() {
            facade.subscribe(
                l.qiuyinProxy.QIUYIN_DATA_UPDATE,
                this.onDataUpdate,
                this
            );
            facade.subscribe(
                l.qiuyinProxy.QIUYIN_SELECT_HERO,
                this.onSelectHero,
                this
            );
            this.onInfo();
        ...
        e.prototype.onInfo = function() {
            this.herolist.selectHandle = function(t) {
                var e = t;
                if (null != e) {
                    l.qiuyinProxy.selectHeroId = e.hid;
                    facade.send(l.qiuyinProxy.QIUYIN_SELECT_HERO);
                }
            };
            this.herolist.data = l.qiuyinProxy.data.rwds;
            var t = l.qiuyinProxy.data.rwds[0];
            l.qiuyinProxy.selectHeroId = t ? t.hid : 0;
            this.herolist.selectData = t;
        };
        e.prototype.onClickRank = function() {
            n.utils.openPrefabView("qiuyin/QiuYinView");
        };
        ...
        e.prototype.onDataUpdate = function() {
            for (
                var t = l.qiuyinProxy.getHeroRwd(l.qiuyinProxy.selectHeroId),
                    e = 0,
                    o = 0;
                o < t.rwd.length;
                o++
