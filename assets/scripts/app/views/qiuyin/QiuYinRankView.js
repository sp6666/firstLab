...
var i = require("../../component/List"),
    ...
    c = (function(t) {
        ...
        e.prototype.onLoad = function() {
            facade.subscribe(l.qiuyinProxy.QIUYIN_RANK, this.onRank, this);
            facade.subscribe(l.qiuyinProxy.QIUYIN_MY_RID, this.onMyRid, this);
            this.onRank();
            this.onMyRid();
            this.onTimer();
        ...
        e.prototype.onRank = function() {
            this.list.data = l.qiuyinProxy.rank;
            var t = l.limitActivityProxy.getActivityData(
                    l.limitActivityProxy.QIUYIN_ID
                ),
                e =
                    !!t &&
        ...
        e.prototype.onMyRid = function() {
            ...
            var t =
                null == l.qiuyinProxy.myRid
                    ? 0
                    : null == l.qiuyinProxy.myRid.rid
                    ? 0
                    : l.qiuyinProxy.myRid.rid;
            this.lblMyRank.string = 0 == t ? i18n.t("RAKN_UNRANK") : t + "";
            this.lblMyScore.string = l.qiuyinProxy.myRid
                ? l.qiuyinProxy.myRid.score + ""
                : "0";
        };
        ...
        e.prototype.onClickRe = function() {
            l.rankProxy.sendRefresh(l.qiuyinProxy.data.info.id);
        };
