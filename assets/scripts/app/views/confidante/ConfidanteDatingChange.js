...
var i = require("../user/UserClothe"),
    ...
    (function(t) {
        ...
        e.prototype.onLoad = function() {
            ...
            null == t &&
                null != (t = n.timeProxy.getLoacalValue(n.confidanteProxy.CONFIDANT_PVE_SAVE)) &&
                (t = JSON.parse(t + ""));
            ...
            this.tags = this._curGate.value.clothe_score;
            ...
            //进入的时候调用一下新手引导, 类型12
            if(n.confidanteProxy.getStatus() == 0)  //新玩家才走这里
            {
                this.scheduleOnce(()=>{
                    facade.send(n.guideProxy.UPDATE_TRIGGER_GUIDE, 
                        {type: 12, value: n.confidanteProxy.lastChapter + "|" + n.confidanteProxy.lastLevel + "|" + n.playerProxy.clothePartType});
                },0.1);
            }
        ...
        e.prototype.onClickOver = function() {
            if (this.checkBuyItem()) {
                ...
                t.effect = this._eff;
                t.head = this._head;
                n.timeProxy.saveLocalValue(n.confidanteProxy.CONFIDANT_PVE_SAVE, JSON.stringify(t));

                n.confidanteProxy.sendClearance(1, this._curGate.chapter, this._curGate.lv, t.head, t.body, t.ear, t.background, t.effect, t.animal);
                this.onClickClost();
            }
        };
