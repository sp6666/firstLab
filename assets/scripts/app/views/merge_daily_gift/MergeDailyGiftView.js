...
var i = require("../../component/List"),
    ...
    d = (function (t) {
        ...
        e.prototype.onLoad = function () {
            /*
            facade.subscribe(
                n.mergePurchaseProxy.MERGE_PURCHASE_DATA_UPDATA,
                this.onShowData,
                this
            );*/
            facade.subscribe(
                n.mergeDailyGiftProxy.UPDATE_MERGE_DAILY_GIFT_PURCASE,
                this.onShowData,
                this
            );
            facade.subscribe("UI_TOUCH_MOVE_LEFT", this.onclickClose, this);
            n.mergeDailyGiftProxy.senOpenJieqi();
            //n.mergePurchaseProxy.sendOpenPrince();
        };
        e.prototype.onShowData = function () {
            var t = n.mergeDailyGiftProxy.info,
                e = n.mergeDailyGiftProxy.purchase;
            // o = n.mergePurchaseProxy.gift;
            if (t && e /*&& o*/ ) {
                this.msg.string = t.msg;
                /*
                for (var i = [], s = 0; s < e.length; s++) i.push(e[s]);
                for (s = 0; s < n.mergePurchaseProxy.gift.length; s++) {
                    var c = o[s];
                    if (6211 == c.type) {
                ...
                n.mergeDailyGiftProxy.purchase.sort(function (t, e) {
                    var o = t.limit > 0 ? 0 : 1,
                        i = e.limit > 0 ? 0 : 1;
                    return o != i ?
                        o - i :
                ...
                this.list.data = n.mergeDailyGiftProxy.purchase;
