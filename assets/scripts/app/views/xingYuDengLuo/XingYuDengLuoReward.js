...
var i = require("../../component/List"),
    ...
    _ = (function(t) {
        ...
        e.prototype.onLoad = function() {
            facade.subscribe(
                r.xingYuDengLuoProxy.XINGYUDENGLUO_MY_RANK,
                this.onRank,
                this
            );
            r.xingYuDengLuoProxy.sendLookRank();
            this.lbldate.string =
                n.timeUtil.format(
                    r.xingYuDengLuoProxy.data.info.sTime,
                    "yyyy-MM-dd"
                ) +
                i18n.t("COMMON_ZHI") +
                n.timeUtil.format(r.xingYuDengLuoProxy.data.info.eTime, "yyyy-MM-dd");
            var t = this;
            l.uiUtils.countDown(
            ...
            var t = Math.ceil(r.xingYuDengLuoProxy.data.rwd[0].member.length / 6),
            e = 106 * t + 10 * (t - 1) + 65;
            this.list.setWidthHeight(550, e);
            this.list.data = r.xingYuDengLuoProxy.data.rwd;
        };
        e.prototype.onRank = function() {
            this.lblMyRank.string = r.xingYuDengLuoProxy.myRank.rid
                ? r.xingYuDengLuoProxy.myRank.rid + ""
                : i18n.t("RAKN_UNRANK");

            this.lblMyScore.string = r.xingYuDengLuoProxy.myRank.score + "";
        };
        e.prototype.onClickRank = function() {
            n.utils.openPrefabView("limitactivity/AtListRankView", null, {
                isTangYuan: !0,
                id: r.xingYuDengLuoProxy.data.info.id
            });
        };
