...
var i = require("../../component/List"),
    ...
    _ = (function(t) {
        ...
        e.prototype.onLoad = function() {
            facade.subscribe(
                n.kaixueProxy.KAIXUE_RANK_UPDATE,
                this.updateMyScore,
                this
            );
            var t = Math.ceil(n.kaixueProxy.data.rwd[0].member.length / 6),
                e = 80 * t + 10 * (t - 1) + 65;
            this.list.setWidthHeight(550, e);
            this.list.data = n.kaixueProxy.data.rwd;

            n.kaixueProxy.sendPaiHang();
            //this.updateMyScore();
        };
        e.prototype.onClickRank = function() {
            l.utils.openPrefabView("kaixue/KaiXueRankView");
        };
        e.prototype.updateMyScore = function() {
            this.lblFuQi.string =
                i18n.t("HEDENG_LEI_JI_JI_FEN") +
                ":" +
                n.kaixueProxy.myRid.score;
            this.lblPaiMing.string =
                i18n.t("ARBOR_DAY_CUR_RANK") + ":" + n.kaixueProxy.myRid.rid;
            this.lblTime.string = i18n.t("AT_LIST_ACTIVITY_CD");
            var t = this;
            r.uiUtils.countDown(
                n.kaixueProxy.data.info.eTime,
                this.lblTime,
                function() {
