...
var i = require("../../Initializer"),
    ...
    c = (function(t) {
        ...
        e.prototype.onRank = function() {
            this.list.data = i.kaixueProxy.ssRank;
            var t = i.limitActivityProxy.getActivityData(
                    i.limitActivityProxy.KAIXUE_ID
                ),
                e =
                    !!t &&
        ...
        e.prototype.onMyRid = function() {
            ...
            var t =
                null == i.kaixueProxy.myRid
                    ? 0
                    : null == i.kaixueProxy.myRid.rid
                    ? 0
                    : i.kaixueProxy.myRid.rid;
            this.lblMyRank.string = 0 == t ? i18n.t("RAKN_UNRANK") : t + "";
            this.lblMyScore.string = i.kaixueProxy.myRid
                ? i.kaixueProxy.myRid.score + ""
                : "0";
        };
        ...
        e.prototype.onClickRe = function() {
            i.rankProxy.sendRefresh(i.kaixueProxy.data.info.id);
        };
