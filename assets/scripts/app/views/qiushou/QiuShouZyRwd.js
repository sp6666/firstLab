...
var i = require("../../component/List"),
    ...
    d = (function(t) {
        ...
        e.prototype.onLoad = function() {
            ...
            if (
                (t =
                    r.qiushouProxy.data.set[0].score >
                    r.qiushouProxy.data.set[1].score
                        ? r.qiushouProxy.data.set[0]
                        : r.qiushouProxy.data.set[0].score <
                          r.qiushouProxy.data.set[1].score
                        ? r.qiushouProxy.data.set[1]
                        : null)
            ) {
                var e = localcache.getItem(localdb.table_hero, t.pkID);
                this.lblWin.string = i18n.t("QIUSHOU_DANG_QIAN_LING_XIAN", {
                    name: e.name
                });
                this.url.url = a.uiHelps.getServantSpine(e.heroid);
            } else
                this.lblWin.string = i18n.t("QIUSHOU_DANG_QIAN_LING_XIAN", {
                    name: i18n.t("QIUSHOU_WEI_CHANG_CHU")
                });
            this.listWin.data = r.qiushouProxy.data.winrwd;
            this.listLost.data = r.qiushouProxy.data.lostrwd;
        };
